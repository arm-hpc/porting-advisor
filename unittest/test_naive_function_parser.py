...
class TestNaiveFunctiontParser(unittest.TestCase):
    def test_parse_line(self):
        ...
        self.assertEquals(function_parser.current_function, 'single_line_function_definition')
        ...
        self.assertEquals(function_parser.current_function, 'multi_line_function_definition1')
        function_parser.parse_line('    function body')
        self.assertEquals(function_parser.current_function, 'multi_line_function_definition1')
        function_parser.parse_line('}')
        self.assertIsNone(function_parser.current_function)
        ...
        self.assertEquals(function_parser.current_function, 'multi_line_function_definition2')
        function_parser.parse_line('    function body')
        self.assertEquals(function_parser.current_function, 'multi_line_function_definition2')
        function_parser.parse_line('}')
        self.assertIsNone(function_parser.current_function)
        ...
        function_parser.parse_line('(int arg1)')
        function_parser.parse_line('{')
        self.assertEquals(function_parser.current_function, 'multi_line_function_definition3')
        function_parser.parse_line('    function body')
        self.assertEquals(function_parser.current_function, 'multi_line_function_definition3')
        function_parser.parse_line('}')
        self.assertIsNone(function_parser.current_function)
        ...
        function_parser.parse_line(')')
        function_parser.parse_line('{')
        self.assertEquals(function_parser.current_function, 'multi_line_function_definition4')
        function_parser.parse_line('    function body')
        self.assertEquals(function_parser.current_function, 'multi_line_function_definition4')
        function_parser.parse_line('}')
        self.assertIsNone(function_parser.current_function)
        ...
        function_parser.parse_line(')')
        function_parser.parse_line('{')
        self.assertEquals(function_parser.current_function, 'multi_line_function_definition5')
        function_parser.parse_line('    function body')
        self.assertEquals(function_parser.current_function, 'multi_line_function_definition5')
        function_parser.parse_line('}')
        self.assertIsNone(function_parser.current_function)
        ...
        self.assertEquals(function_parser.current_function, 'func')
