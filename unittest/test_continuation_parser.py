...
from advisor.continuation_parser import ContinuationParser
import unittest
...
class TestOsFilter(unittest.TestCase):
    def test_parse_line(self):
        ...
        self.assertEquals(line, 'just a line')
        ...
        self.assertEquals(line, '#define MACRO first line of macro second line of macro')
